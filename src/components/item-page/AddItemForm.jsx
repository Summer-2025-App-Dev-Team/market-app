export default function addItemForm(props) {
    ...
    return (
        <form>
            ...
            <input type="number" name="price" id="price" placeholder="Price (SGD)" aria-label="price" />
            <label htmlFor="date">Available until</label>
            <input type="date" name="date" id="date" placeholder="Available until" aria-label="date" />
